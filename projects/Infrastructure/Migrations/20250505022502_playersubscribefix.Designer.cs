...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250505022502_playersubscribefix")]
    partial class playersubscribefix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Championship", b =>
                {
                    ...
                    b.ToTable("tb_championship", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.EventGame", b =>
                {
                    ...
                    b.ToTable("tb_event_game", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.Group", b =>
                {
                    ...
                    b.Property<int>("SharedVacancyForNextStage")
                        .HasColumnType("int");

                    b.Property<string>("StageId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<int>("VacancyForNextStage")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.Match", b =>
                {
                    ...
                    b.ToTable("tb_match", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.Player", b =>
                {
                    ...
                    b.ToTable("tb_player", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.PlayerSubscribe", b =>
                {
                    ...
                    b.ToTable("tb_player_subscribe", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.TeamSubscribe", b =>
                {
                    ...
                    b.ToTable("tb_team_subscribe", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Models.Group", b =>
                {
                    b.HasOne("Domain.Models.Stage", null)
                        .WithMany("Groups")
            ...
            modelBuilder.Entity("Domain.Models.PlayerSubscribe", b =>
                {
                    b.HasOne("Domain.Models.Championship", null)
                        .WithMany("Players")
                    ...
                    b.HasOne("Domain.Models.TeamSubscribe", null)
                        .WithMany("Players")
