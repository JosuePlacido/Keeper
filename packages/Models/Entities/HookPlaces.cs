...
{
    public class HookPlacesBase : IEntidade
    {
    ...
    public override bool Equals(object obj)
    {
        ...
        HookPlacesBase p2 = obj as HookPlacesBase;
        if (p2 == null)
        {
            return false;
        }
    ...
    {
        int hash = 37;
        hash = hash * 23 + typeof(HookPlacesBase).GetHashCode();
...
[Table("tb_hook_place")]
public class HookPlaces : HookPlacesBase
{
